...
class UserGuruController extends Controller
{
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $query = User::with('guru')->where('POSISI', 'GURU');

            return DataTables::of($query)
                ->addColumn('action', function ($item) {
                    return '
                        <a href="' . route('user-guru.edit', $item->id). '" class="btn btn-warning btn-sm shadow-sm mr-1" title="Edit"><i class="fas fa-pen"></i></a>
        ...
        return view('pages.users-guru.index', compact('users'));
    ...
    public function create()
    {
        ...
        return view('pages.users-guru.create', compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Alert::toast('Guru Berhasil Disimpan!','success');
            return redirect()->route('user-guru.index');
    ...
    public function edit(string $id)
    {
        ...
        $roles = Role::where('name', 'guru')->get();
        return view('pages.users-guru.edit', compact('user', 'roles'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            //redirect dengan pesan sukses
            Alert::toast('Guru Berhasil Diupdate!','success');
            return redirect()->route('user-guru.index');
