...
<!-- swiper css -->
<link rel="stylesheet" href="{{ asset('Admin/dist/assets/libs/swiper/swiper-bundle.min.css') }}">
...
<link rel="stylesheet" href="{{ asset('Admin/dist/assets/libs/@simonwep/pickr/themes/classic.min.css') }}" /> <!-- 'classic' theme -->
<link rel="stylesheet" href="{{ asset('Admin/dist/assets/libs/@simonwep/pickr/themes/monolith.min.css') }}" /> <!-- 'monolith' theme -->
<link rel="stylesheet" href="{{ asset('Admin/dist/assets/libs/@simonwep/pickr/themes/nano.min.css') }}" /> <!-- 'nano' theme -->
