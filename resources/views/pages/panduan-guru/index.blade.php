            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('panduan-guru.destroy', $item->id) }}" method="POST"
        ...
        <div class="card">
            <div class="card-body">
                <div class="flex-container mb-4">
                    ...
                    <a href="{{ route('panduan-guru.create') }}" class="btn btn-success btn-sm btn-flat">Tambah</a>
                </div>
