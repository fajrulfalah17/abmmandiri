    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <h6>Form Edit Panduan :</h6>

                <form action="{{ route('panduan-operator.update', $panduan->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('put')
                    <div class="row mt-2">
                        <div class="col-4">
                            ...
                            <input type="text" placeholder="" name="judul" id="formrow-firstname-input"
                                value="{{ old('judul', $panduan->judul) }}" class="form-control @error('judul') is-invalid @enderror">
                            @error('judul')
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" placeholder="" name="link" id="link" value="{{ old('link', $panduan->link) }}"
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            <textarea class="form-control deskripsi @error('deskripsi') is-invalid @enderror" name="deskripsi"
                                placeholder="Masukkan Konten / Deskripsi Berita" rows="10">{!! old('deskripsi', $panduan->deskripsi) !!}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
