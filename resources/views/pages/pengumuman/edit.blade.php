                    ...
                    <div class="row mt-2">
                        <div class="col-4">
                            ...
                            <input type="text" placeholder="" name="judul" id="formrow-firstname-input"
                                value="{{ old('judul', $pengumuman->judul) }}" class="form-control @error('judul') is-invalid @enderror">
                            @error('judul')
                        ...
                        <div class="col-4">
                            ...
                            <input type="date" placeholder="" name="tanggal" id="tanggal" value="{{ old('tanggal', $pengumuman->tanggal) }}"
                        ...
                        <div class="col-4">
                            ...
                            <input type="time" name="jam" class="form-control @error('jam') is-invalid @enderror" value="{{ old('jam', $pengumuman->jam) }}"
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            <textarea class="form-control isi @error('isi') is-invalid @enderror" name="isi"
                                placeholder="Masukkan Konten / Isi Berita" rows="10">{!! old('isi', $pengumuman->isi) !!}</textarea>
                            @error('isi')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
