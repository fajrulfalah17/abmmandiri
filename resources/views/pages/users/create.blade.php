    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user-admin.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="row mt-2">
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" placeholder="" name="username"
                                id="formrow-firstname-input"  value="{{ old('username') }}" class="form-control @error('username') is-invalid @enderror">
                                @error('username')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
