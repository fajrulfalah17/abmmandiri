    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user-guru.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            ...
                            <input type="text" placeholder="" name="mgmp" id="mgmp"
                                value="{{ old('mgmp', $user->guru->mgmp) }}"
                                class="form-control @error('mgmp') is-invalid @enderror" readonly>
                            @error('mgmp')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" placeholder="" name="asal_sekolah" id="formrow-firstname-input"
                                value="{{ old('asal_sekolah', $user->guru->asal_sekolah) }}"
