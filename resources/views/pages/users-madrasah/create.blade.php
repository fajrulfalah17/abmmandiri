    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <h6>Form Tambah User Madrasah :</h6>

                <form action="{{ route('user-madrasah.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="row mt-2">
                        <div class="col-4">
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="formrow-firstname-input" class="form-label">NSM Madrasah</label>
                            <input type="text" placeholder="" name="nsm"
                                id="nsm"  value="{{ old('nsm') }}" class="form-control @error('nsm') is-invalid @enderror" readonly>
                                @error('nsm')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" placeholder="" name="npsn"
                                id="formrow-firstname-input"  value="{{ old('npsn') }}" class="form-control @error('npsn') is-invalid @enderror">
                                @error('npsn')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6" style="display: none;">
                        <div class="form-group">
                            <select name="posisi" id="">
                                <option value="MADRASAH"selected>MADRASAH</option>
