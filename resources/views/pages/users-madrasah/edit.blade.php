    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('user-madrasah.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('put')
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            ...
                            <input type="text" placeholder="" name="nsm" id="nsm"
                                value="{{ old('nsm', $user->madrasah->nsm) }}"
                                class="form-control @error('nsm') is-invalid @enderror" readonly>
                            @error('nsm')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" placeholder="" name="npsn" id="formrow-firstname-input"
                                value="{{ old('npsn', $user->madrasah->npsn) }}"
